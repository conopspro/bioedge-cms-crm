  ...
  return (
    <section className="py-6 px-8">
      <div className="mx-auto max-w-[1200px]">
        <Link
          href="/clinics"
          className="group relative block overflow-hidden rounded-2xl border border-deep-blue/20 transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_10px_20px_rgba(13,89,138,0.15)]"
        >
          ...
          <div className="flex items-center gap-6 px-6 py-4 md:gap-8 md:px-8">
            ...
            {/* Icon */}
            <div className="flex h-20 w-20 flex-shrink-0 items-center justify-center rounded-xl bg-navy/10 shadow-xl transition-transform duration-300 group-hover:scale-105">
              <MapPin className="h-10 w-10 text-navy" />
            </div>
            ...
            {/* CTA */}
            <span className="hidden flex-shrink-0 items-center gap-2 rounded-full bg-electric-blue px-5 py-2 text-sm font-semibold text-white transition-colors group-hover:bg-navy sm:inline-flex">
              Find a Clinic
