...
import { Plus, Loader2, Play, BookOpen, Book, Link as LinkIcon, Sparkles } from "lucide-react"
...
/**
 * Form dialog for manually adding enhancements
 */
      ...
      <DialogContent className="sm:max-w-[425px]">
        <form onSubmit={handleSubmit}>
          <DialogHeader>
            ...
            <DialogDescription>
              Manually add a video, paper, book, or link to this article.
            </DialogDescription>
          </DialogHeader>
