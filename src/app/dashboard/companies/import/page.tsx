    ...
    <div className="space-y-6 p-6 max-w-5xl mx-auto">
      ...
      {step === 1 && (
        <div className="space-y-6">
          ...
          {/* Maintenance tools — always available */}
          <div className="rounded-md bg-muted/50 border p-3 flex items-center justify-between gap-4">
            <p className="text-sm text-muted-foreground">
              Fix existing contacts where name shows as "Unknown" — replaces with email local-part and removes generic role addresses (info@, admin@, etc.).
            </p>
